...
//			}
			...
			if(food==null) {
				System.out.println("该食品不存在！");
				return ;
			}else if(!food.getBusinessId().equals(businessId)) {
//				System.out.println(businessId);
//				System.out.println(food.getBusinessId());
				System.out.println("无权修改该食品！");
				return ;
			}else {
				System.out.println(food);
			}
...
//			if(food!=null) {
//				System.out.println(food);
//			}else if(food.getBusinessId()!=businessId) {
//				System.out.println("无权删除该食品！");
//			}else {
//				System.out.println("该食品不存在！");
//				return ;
//			}
