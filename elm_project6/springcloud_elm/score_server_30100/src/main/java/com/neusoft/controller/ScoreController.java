...
public class ScoreController {
	...
	public CommonResult<Integer> gainCredit(
			...
			@PathVariable("channelId") Integer channelId) throws Exception{
	...
	public CommonResult<Integer> getCredit(@PathVariable("userId") String userId) throws Exception {
		int result = scoreService.getCreditByUserId(userId);
		return new CommonResult(200, "success", result);
	}
	
	@GetMapping("/listGainLog/{userId}")
	public CommonResult<List<ScoreVO>> listGainLog(@PathVariable("userId") String userId) throws Exception {
	...
	public CommonResult<List<ScoreVO>> listUseLog(ScoreVO scoreVO) throws Exception {
